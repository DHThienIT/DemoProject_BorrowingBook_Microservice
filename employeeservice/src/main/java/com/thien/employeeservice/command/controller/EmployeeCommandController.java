...
import com.thien.employeeservice.command.model.MessageDTO;
...
public class EmployeeCommandController {
	...
	public MessageDTO SendMessage(@RequestBody EmployeeRequestModel model) {
		MessageDTO messageDTO = new MessageDTO(model.getLastName() + " " + model.getFirstName(), "Test XXX",
				"Đây là Test gửi từ EmployeeService!", new Date());
