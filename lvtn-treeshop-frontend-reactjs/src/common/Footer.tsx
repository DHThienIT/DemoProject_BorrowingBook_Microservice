                    ...
                    <section className="footer-main padding-y">
                        <div className="row">
                            <aside className="col-lg-3 design-group">
                                <img src="../assets/images/logo2.jpg" alt="Avatar Logo" style={{ width: "260px" }} className="rounded-pill" />

                                <article className="me-lg-1">
                                    <p className="mt-3"><b>Shop vườn xanh đa dạng cây trồng</b></p>
                                </article>
                                <div className="show-iconD">
                                    <img className="iconD" src='../assets/icons/google.png' style={{ width: "25px" }}></img>
                                    <img className="iconD" src='../assets/icons/facebook.png' style={{ width: "25px" }}></img>
                                    <img className="iconD" src='../assets/icons/twitter.png' style={{ width: "25px" }}></img>
                                    <img className="iconD" src='../assets/icons/youtube.png' style={{ width: "25px" }}></img>
                                </div>
                            </aside>
